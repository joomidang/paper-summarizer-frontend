  ...
  return (
    <div>
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-[#5F5F5F] font-bold text-3xl mb-8">
          논문의 본질을 이해하는 가장 빠른 방법
        </h2>
        <div className="mt-6">
          <button 
            onClick={handleGithubLoginBtn}
            className="flex items-center gap-3 bg-[#24292F] hover:bg-[#2c3238] text-white py-3 px-6 rounded-lg transition-colors duration-300 shadow-md"
          >
            ...
            <span className="font-medium text-base">GitHub로 로그인</span>
          </button>
        </div>
